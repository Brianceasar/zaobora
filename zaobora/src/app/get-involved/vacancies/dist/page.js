    ...
    return (React.createElement("div", { className: "min-h-screen bg-white" },
        ...
        React.createElement("section", { className: "relative pt-20 md:pt-24 pb-12 md:pb-16 bg-gradient-to-br from-green-50 via-white to-emerald-100" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 text-center" },
                React.createElement("nav", { className: "flex justify-center gap-2 text-sm text-gray-600 mb-6" },
                    ...
                    React.createElement("span", { className: "text-green-600 font-medium" }, "Vacancies")),
                React.createElement("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight" },
                    "Explore",
                    " ",
                    React.createElement("span", { className: "bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent" }, "Career Opportunities")))),
        React.createElement("section", { className: "py-16 md:py-20 bg-white" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl" },
                React.createElement("h2", { className: "text-3xl font-bold text-gray-900 mb-6 text-center" }, "Current Openings"),
                React.createElement("div", { className: "space-y-6" },
                    React.createElement("div", { className: "p-6 border rounded-xl shadow-sm hover:shadow-md transition" },
                        React.createElement("h3", { className: "text-xl font-semibold text-gray-800" }, "Program Officer"),
                        React.createElement("p", { className: "text-gray-600 mt-2" }, "Support field activities and ensure program goals are achieved.")),
                    React.createElement("div", { className: "p-6 border rounded-xl shadow-sm hover:shadow-md transition" },
                        React.createElement("h3", { className: "text-xl font-semibold text-gray-800" }, "Communications Intern"),
                        React.createElement("p", { className: "text-gray-600 mt-2" }, "Assist in creating awareness content and social media campaigns."))))),
        React.createElement("section", { className: "py-16 md:py-20 bg-gray-50" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl" },
                React.createElement("div", { className: "bg-white rounded-2xl shadow-lg p-8 md:p-12" },
                    React.createElement("h2", { className: "text-2xl font-bold text-gray-900 mb-8 text-center" }, "Submit Your Application"),
                    submitStatus === "success" && (React.createElement("div", { className: "mb-6 p-4 bg-green-50 border border-green-200 rounded-lg text-green-700" }, "\u2705 Your application has been submitted successfully.")),
                    ...
                    React.createElement("form", { onSubmit: handleSubmit, className: "space-y-6" },
                        ...
                        React.createElement("input", { type: "url", name: "cv", value: formData.cv, onChange: handleInputChange, placeholder: "Link to CV / Resume", className: "w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500" }),
                        React.createElement("textarea", { name: "message", value: formData.message, onChange: handleInputChange, placeholder: "Why are you a good fit?", rows: 4, className: "w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 resize-none" }),
        ...
        showModal && (React.createElement("div", { className: "fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" },
            React.createElement("div", { className: "bg-white rounded-2xl p-8 max-w-md w-full text-center" },
                ...
                React.createElement("h3", { className: "text-xl font-bold text-gray-900 mb-2" }, "Application Sent"),
                React.createElement("p", { className: "text-gray-600 mb-6" }, "Thank you for applying! We\u2019ll review your application and get back to you soon."),
