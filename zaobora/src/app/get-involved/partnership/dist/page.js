...
var PartnerWithUsPage = function () {
    ...
    return (React.createElement("div", { className: "min-h-screen bg-white" },
        ...
        React.createElement("section", { className: "relative pt-20 md:pt-24 pb-12 md:pb-16 bg-gradient-to-br from-green-50 via-white to-emerald-50" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 text-center" },
                React.createElement("nav", { className: "flex justify-center gap-2 text-sm text-gray-600 mb-6" },
                    ...
                    React.createElement("span", { className: "text-green-600 font-medium" }, "Partner with Us")),
                React.createElement("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight" },
                    "Partner with us to",
                    " ",
                    React.createElement("span", { className: "bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent" }, "create impact")))),
        React.createElement("section", { className: "py-16 md:py-20 bg-white" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center" },
                React.createElement("h2", { className: "text-3xl font-bold text-gray-900 mb-6" }, "Why Partner With Us?"),
                React.createElement("p", { className: "text-lg text-gray-600 leading-relaxed" }, "We collaborate with organizations, institutions, and changemakers to scale up solutions for sustainable agriculture, climate action, and community development. By partnering with us, your organization contributes to meaningful change while gaining visibility, trust, and shared knowledge."))),
        React.createElement("section", { className: "py-16 md:py-20 bg-gray-50" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl" },
                React.createElement("div", { className: "bg-white rounded-2xl shadow-lg p-8 md:p-12" },
                    React.createElement("h2", { className: "text-2xl font-bold text-gray-900 mb-8 text-center" }, "Partnership Application Form"),
                    submitStatus === "success" && (React.createElement("div", { className: "mb-6 p-4 bg-green-50 border border-green-200 rounded-lg text-green-700" }, "\u2705 Your request has been submitted. We\u2019ll get back to you soon.")),
                    ...
                    React.createElement("form", { onSubmit: handleSubmit, className: "space-y-6" },
                        React.createElement("input", { type: "text", name: "organization", value: formData.organization, onChange: handleInputChange, placeholder: "Organization / Company Name", required: true, className: "w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500" }),
                        React.createElement("input", { type: "text", name: "contactName", value: formData.contactName, onChange: handleInputChange, placeholder: "Contact Person Name", required: true, className: "w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500" }),
                        React.createElement("input", { type: "email", name: "email", value: formData.email, onChange: handleInputChange, placeholder: "Contact Email", required: true, className: "w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500" }),
                        React.createElement("textarea", { name: "message", value: formData.message, onChange: handleInputChange, placeholder: "Tell us about your partnership interests", rows: 4, className: "w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 resize-none" }),
        ...
        showModal && (React.createElement("div", { className: "fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" },
            React.createElement("div", { className: "bg-white rounded-2xl p-8 max-w-md w-full text-center" },
                ...
                React.createElement("p", { className: "text-gray-600 mb-6" }, "Your partnership application has been submitted. Our team will reach out shortly."),
...
exports["default"] = PartnerWithUsPage;
