    ...
    return (React.createElement("div", { className: "min-h-screen bg-white" },
            ...
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10" },
                React.createElement("div", { className: "max-w-4xl mx-auto text-center" },
                    React.createElement("nav", { className: "flex items-center justify-center gap-2 text-sm text-gray-600 mb-6 transform transition-all duration-1000 " + (isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0') },
                        ...
                        React.createElement("span", { className: "text-green-600 font-medium" }, "Services")),
                    React.createElement("div", { className: "mb-8 transform transition-all duration-1000 delay-200 " + (isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0') },
                        ...
                        React.createElement("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight" },
                        ...
                        React.createElement("p", { className: "text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed" }, service_list_1.SERVICES_CONTENT.description)),
                    React.createElement("div", { className: "grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto transform transition-all duration-1000 delay-400 " + (isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0') },
                        React.createElement("div", { className: "text-center" },
                            React.createElement("div", { className: "text-2xl md:text-3xl font-bold text-green-600" }, service_list_1.SERVICES_CONTENT.cards.length),
                            React.createElement("div", { className: "text-sm md:text-base text-gray-600" }, "Services")),
                        React.createElement("div", { className: "text-center" },
                            React.createElement("div", { className: "text-2xl md:text-3xl font-bold text-emerald-600" }, "1000+"),
                            React.createElement("div", { className: "text-sm md:text-base text-gray-600" }, "Farmers Served")),
                        React.createElement("div", { className: "text-center" },
                            React.createElement("div", { className: "text-2xl md:text-3xl font-bold text-green-600" }, "5+"),
                            React.createElement("div", { className: "text-sm md:text-base text-gray-600" }, "Years Experience")))))),
        React.createElement("section", { className: "bg-white border-b border-gray-200 sticky top-16 md:top-20 z-40" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-4" },
                React.createElement("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center gap-4" },
                    React.createElement("div", { className: "flex items-center gap-3 flex-wrap" },
                        ...
                        categories.map(function (category) { return (React.createElement("button", { key: category, onClick: function () { return setSelectedCategory(category); }, className: "px-3 py-1.5 rounded-full text-sm font-medium transition-all duration-300 whitespace-nowrap " + (selectedCategory === category
            ...
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8" },
                React.createElement("div", { className: "mb-8 text-center" },
                    React.createElement("p", { className: "text-gray-600" },
                        "Showing ",
                        React.createElement("span", { className: "font-semibold text-green-600" }, filteredServices.length),
                ...
                React.createElement("div", { className: "" + (viewMode === 'grid'
                        ...
                        : 'space-y-6') }, filteredServices.map(function (service, index) { return (React.createElement("div", { key: service.id, className: "transform transition-all duration-700 " + (visibleCards.includes(index)
                        ? 'translate-y-0 opacity-100'
                        : 'translate-y-10 opacity-0'), style: { transitionDelay: index * 50 + "ms" } }, viewMode === 'grid' ? (
                // Grid Card View
                React.createElement(link_1["default"], { href: service.href, className: "group block bg-white rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 \n                             hover:border-green-200 transition-all duration-500 transform hover:-translate-y-2 overflow-hidden" },
                    ...
                    React.createElement("div", { className: "relative z-10 p-6 md:p-8" },
                        React.createElement("div", { className: "mb-6" },
                            React.createElement("div", { className: "relative w-16 h-16 mx-auto" },
                                React.createElement("div", { className: "w-16 h-16 rounded-2xl bg-gradient-to-br " + service.bgColor + " \n                                         flex items-center justify-center shadow-lg transform \n                                         group-hover:rotate-6 group-hover:scale-110 transition-all duration-500" }, service.icon ? (React.createElement(service.icon, { className: "w-8 h-8 text-white" })) : (React.createElement("span", { className: "text-2xl" }, service.emoji))))),
                        React.createElement("div", { className: "text-center mb-3" },
                            React.createElement("span", { className: "inline-block px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium" }, service.category)),
                        ...
                        React.createElement("p", { className: "text-gray-600 text-center mb-6 leading-relaxed line-clamp-3" }, service.shortDescription),
                        service.features && (React.createElement("ul", { className: "space-y-1 mb-6" }, service.features.slice(0, 2).map(function (feature, idx) { return (React.createElement("li", { key: idx, className: "flex items-center text-sm text-gray-600" },
                            React.createElement("div", { className: "w-1.5 h-1.5 bg-green-500 rounded-full mr-2 flex-shrink-0" }),
                            React.createElement("span", { className: "line-clamp-1" }, feature))); }))),
                        React.createElement("div", { className: "text-center" },
                    ...
                    React.createElement("div", { className: "absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r " + service.bgColor + " \n                                  transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500" }))) : (
                // List View
                React.createElement(link_1["default"], { href: service.href, className: "group block bg-white rounded-2xl shadow-lg hover:shadow-xl border border-gray-100 \n                             hover:border-green-200 transition-all duration-300 overflow-hidden" },
                    React.createElement("div", { className: "p-6 md:p-8" },
                        React.createElement("div", { className: "grid md:grid-cols-4 gap-6 items-center" },
                            React.createElement("div", { className: "text-center md:text-left" },
                                React.createElement("div", { className: "w-16 h-16 rounded-2xl bg-gradient-to-br " + service.bgColor + " \n                                         flex items-center justify-center shadow-lg mx-auto md:mx-0 mb-3 \n                                         transform group-hover:scale-110 transition-all duration-500" }, service.icon ? (React.createElement(service.icon, { className: "w-8 h-8 text-white" })) : (React.createElement("span", { className: "text-2xl" }, service.emoji))),
                                React.createElement("span", { className: "inline-block px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium" }, service.category)),
                            React.createElement("div", { className: "md:col-span-2 text-center md:text-left" },
                                ...
                                React.createElement("p", { className: "text-gray-600 leading-relaxed line-clamp-2" }, service.shortDescription)),
                            React.createElement("div", { className: "text-center md:text-right" },
                                React.createElement("span", { className: "inline-flex items-center gap-2 text-green-600 hover:text-green-700 \n                                         font-semibold transition-all duration-300 group-hover:gap-3" },
                                    React.createElement("span", null, "Learn More"),
                                    React.createElement(fa6_1.FaArrowRight, { className: "w-4 h-4 transform group-hover:translate-x-1 transition-transform duration-300" }))))))))); })),
                filteredServices.length === 0 && (React.createElement("div", { className: "text-center py-16" },
                    ...
                    React.createElement("h3", { className: "text-xl font-semibold text-gray-900 mb-2" }, "No Services Found"),
                    React.createElement("p", { className: "text-gray-600 mb-6" }, "Try selecting a different category or view all services."),
                    React.createElement("button", { onClick: function () { return setSelectedCategory('all'); }, className: "bg-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-700 transition-colors duration-300" }, "View All Services"))))),
        React.createElement("section", { className: "bg-gradient-to-r from-green-600 to-emerald-600 py-12 md:py-16" },
            React.createElement("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 text-center" },
                React.createElement("h2", { className: "text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4" }, "Need Help Choosing the Right Service?"),
                React.createElement("p", { className: "text-base md:text-lg lg:text-xl text-white/90 mb-8 max-w-2xl mx-auto" }, "Our agricultural experts are here to help you find the perfect solution for your farming needs."),
                React.createElement("div", { className: "flex flex-col sm:flex-row gap-4 justify-center" },
                    React.createElement(link_1["default"], { href: "/contact", className: "inline-flex items-center justify-center gap-3 bg-white text-green-600 px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300" },
                        React.createElement("span", null, "Get Consultation"),
                        React.createElement(fa6_1.FaArrowRight, { className: "w-5 h-5" })),
                    React.createElement("a", { href: "tel:+255752563361", className: "inline-flex items-center justify-center gap-3 bg-white/20 text-white border-2 border-white/30 px-8 py-4 rounded-xl font-semibold hover:bg-white/30 transition-all duration-300" },
                        React.createElement("span", null, "Call Now"))))),
