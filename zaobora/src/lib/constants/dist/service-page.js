...
exports.SERVICE_PAGES = {
    ...
    "agro-inputs": __assign(__assign({}, service_list_1.SERVICES_CONTENT.cards.find(function (s) { return s.slug === "agro-inputs"; })), { fullDescription: "We supply high-quality agro-inputs tailored to farmer needs...", keyBenefits: ["Improved crop yields", "Resilient seeds and fertilizers", "Timely supply chains", "Better soil management"], detailedServices: [
    ...
    "credit-loans": __assign(__assign({}, service_list_1.SERVICES_CONTENT.cards.find(function (s) { return s.slug === "credit-loans"; })), { fullDescription: "We facilitate affordable input financing for farmer groups...", keyBenefits: ["Improved access to credit", "Group-based lending security", "Financial literacy", "Reduced input barriers"], detailedServices: [
    ...
    "soil-health": __assign(__assign({}, service_list_1.SERVICES_CONTENT.cards.find(function (s) { return s.slug === "soil-health"; })), { fullDescription: "Healthy soils = healthy yields. We provide soil testing and fertility mapping...", keyBenefits: ["Better soil fertility", "Informed fertilizer use", "Sustainable land management"], detailedServices: [
    ...
    "irrigation-systems": __assign(__assign({}, service_list_1.SERVICES_CONTENT.cards.find(function (s) { return s.slug === "irrigation-systems"; })), { fullDescription: "We design and install irrigation systems that optimize water usage...", keyBenefits: ["Water efficiency", "Improved yields", "Reduced water costs"], detailedServices: [
    ...
    "research-data": __assign(__assign({}, service_list_1.SERVICES_CONTENT.cards.find(function (s) { return s.slug === "research-data"; })), { fullDescription: "We turn farmer data into insights for better decisions...", keyBenefits: ["Better planning", "Stronger creditworthiness", "Evidence-based farming"], detailedServices: [
    ...
    "information-access": __assign(__assign({}, service_list_1.SERVICES_CONTENT.cards.find(function (s) { return s.slug === "information-access"; })), { fullDescription: "We bridge the information gap by improving farmer access to localized knowledge...", keyBenefits: ["Timely farming advice", "Improved market linkages", "Community knowledge sharing"], detailedServices: [
    ...
    "investment-management": __assign(__assign({}, service_list_1.SERVICES_CONTENT.cards.find(function (s) { return s.slug === "investment-management"; })), { fullDescription: "We support agricultural investors with end-to-end services...", keyBenefits: ["Secure land access", "Efficient farm operations", "High ROI"], detailedServices: [
